...
public class ShareAndRate : MonoBehaviour
{
    ...
    string subject = "Spider";
    string body = "https://play.google.com/store/apps/details?id=com.spiderhero.gameshaim&hl=en&gl=US";
...
#elif UNITY_IPHONE
  Application.OpenURL("itms-apps://itunes.apple.com/app/com.spiderhero.gameshaim&hl=en&gl=US");
#endif
    }
